...
export const NODE_COLORS: Record<string, string> = {
  ...
  DOCUMENT:     '#5DCAA5',  // teal-light — documents
  MEETING:      '#2B8FD4',  // blue
}
...
export const LINK_COLORS: Record<string, string> = {
  ...
  GOVERNS:      'rgba(232,168,56,0.5)',
  REPRESENTS:   'rgba(216,90,48,0.6)',
  LENDS_TO:     'rgba(95,94,90,0.5)',
  GUARANTEES:   'rgba(226,75,74,0.5)',
  MANAGES:      'rgba(239,159,39,0.5)',
}
